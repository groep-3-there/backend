...
//        teardown();
    ...
    public void testGetChallengesForRangeOfMonthsFilter() throws Exception {
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/graph-data/challenges/filter/date?from=" + from + "&till=" + till)
                                .contentType("application/json")
                )
                .andExpect(status().isOk())
                .andExpect(result -> {
    ...
    public void testGetTotalUsers() throws Exception {
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/graph-data/users/total")
                                .contentType("application/json")
                )
                .andExpect(status().isOk())
                .andExpect(result -> {
    ...
    public void testGetTotalChallengesForCompany() throws Exception {
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/graph-data/companies/"+ company.getId() + "/challenges/total")
                                .contentType("application/json")
                )
                .andExpect(status().isOk())
                .andExpect(result -> {
    ...
    public void testGetCompaniesForRangeOfMonthsFilter() throws Exception {
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/graph-data/companies/filter/date?from=" + from + "&till=" + till)
                                .contentType("application/json")
                )
                .andExpect(status().isOk())
                .andExpect(result -> {

...
public class CreateDepartmentTest {
        ...
        mockMvc
                .perform(
                        MockMvcRequestBuilders.post("/department/create")
                                .content(objectMapper.writeValueAsString(new CreateDepartmentFields("Test Department", 1L)))
    ...
    public void beheerderCanCreateDepartment() throws Exception {
        ...
        mockMvc
                .perform(
                        MockMvcRequestBuilders.post("/department/create")
                                .content(objectMapper.writeValueAsString(new CreateDepartmentFields("Test Department", targetAdmin.id)))
                                .contentType(MediaType.APPLICATION_JSON))

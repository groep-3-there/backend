...
public class ChallengeIntegrationTest {
  ...
  public void testUpdateChallenge() throws Exception {
    ...
    testChallenge.setDescription(
        "Ik wil graag mijn platform verbeteren. Ik zoek een team van 3 personen die mij hierbij"
            + " kunnen helpen.");
  ...
  public void testSearchChallenges() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/challenge/search?query=Management")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/challenge/search?query=Management&company=Jumbo")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.content[0].id").value(testChallenge.id));
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(
                    "/challenge/search?query=Management&company=Jumbo&branche=Advies en"
                        + " consultancy")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.content[0].id").value(testChallenge.id));
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(
                    "/challenge/search?query=Management&branche=Advies en consultancy")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.content[0].id").value(testChallenge.id));
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/challenge/search?branche=Advies en consultancy")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.content[0].id").value(testChallenge.id));
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(
                    "/challenge/search?company=Jumbo&branche=Advies en consultancy")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.content[0].id").value(testChallenge.id));
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/challenge/search?company=Jumbo")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.content[0].id").value(testChallenge.id));
  }
